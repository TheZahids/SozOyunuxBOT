...
def help(update, context):
    update.message.reply_text('Mövcud əmrlər göstərilir:\n' +
...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        update.message.reply_text('Salam, Dostum !\n\nMən qrup oyun botuyam,məni qruplarınıza əlavə edərək oyuna başlayaq 🤠\n\nŞəxsi mesajlarda oyun oynamaq olmaz!', reply_to_message_id=True, reply_markup=reply_markup)
    else:
        ...
        update.message.reply_text('Söz Oyunu Başladı, Uğurlar✨'.format(username), reply_to_message_id=True)
...
def set_master(update, context):
    ...
    update.message.reply_text('[{}](tg://user?id={}) sözü başa salır 🧐\n\nSözü ilk tapan,digər turda aparıcı olacaq. Diqqətiniz burada olsun!'.format(username,user_id), reply_to_message_id=True, reply_markup=reply_markup, parse_mode=ParseMode.MARKDOWN)
...
def is_word_answered(update, context):
    ...
    if game.is_word_answered(user_id, text):
        update.message.reply_text('*{}* sözünü [{}](tg://user?id={}) tapdı ✅\n\nNövbəti turda [{}](tg://user?id={}) aparıcıdır!'.format(word, username,user_id), reply_to_message_id=True, parse_mode=ParseMode.MARKDOWN)
